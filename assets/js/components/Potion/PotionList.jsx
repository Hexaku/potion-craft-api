...
const PotionList = () => {
    ...
    const potionsPerPage = 9;
    const totalPages = Math.ceil(data.length / potionsPerPage);
    ...
    // Client pagination
    const start = currentPage * potionsPerPage - potionsPerPage;
    const paginatedPotions = data.slice(start, start + potionsPerPage);
